...
export const DiscussForm = (actions) => {
  ...
  const submitEmail = () => {
    ...
    const templateParams = {
      ...
      to_name: "maivantam1978@gmail.com",
      message: projectIdea,
    };

    if (name !== "" && company !== "" && email !== "" && phone !== "" && projectIdea !== "") {
      emailjs.send("service_h4gtndg", "template_a9tvs7a", templateParams, "user_csqIxzN5mKsl1yw4ffJzV").then(
        () => {
  ...
  return (
    <section className="flex flex-col container mx-auto mt-10 justify-center">
      <Fade direction="down" triggerOnce>
        <h1 className="text-5xl text-theme-blue text-center font-bold">Let&apos s contact</h1>
      </Fade>
